...
var AllSolidityEvents = require('../lib/web3_hpb/allevents');
...
describe('lib/web3_hpb/allevents', function () {
    describe('decode', function () {
        tests.forEach(function (test, index) {
            it('test no: ' + index, function () {
                var web3_hpb = new web3_hpb();
                var allEvents = new AllSolidityEvents(web3_hpb, test.abi, address);
